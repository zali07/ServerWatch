//-----------------------------------------------------------------------
// <copyright file="ServerCatalogViewModel.generated.cs" company="Cosys SRL.">
...
namespace ServerWatchTower.Agent.ViewModel
{
    ...
    /// </summary>
    [Export("ServerWatchTower.Agent.ServerCatalogViewModel"), PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class ServerCatalogViewModel : ViewModelBase
    {
        ...
        protected override void OnInitialize(object initArguments)
        {
            ...
            {
                if (!(initArguments is ServerCatalogViewArgs))
                {
                    this.NormalizeOpenArgs(ref initArguments);

                    if (initArguments != null && !(initArguments is ServerCatalogViewArgs))
                    {
                        throw ExceptionHelper.NewInvalidViewArgsException("ServerCatalog");
                    }
                }

                this.OpenArgs = (ServerCatalogViewArgs)initArguments;
            }
        ...
        /// <summary>
        /// Initializes the command properties by creating the commands of the <see cref="ServerCatalogViewModel"/>.
        /// </summary>
