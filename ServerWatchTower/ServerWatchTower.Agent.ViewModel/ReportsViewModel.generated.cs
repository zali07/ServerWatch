//-----------------------------------------------------------------------
// <copyright file="ReportsViewModel.generated.cs" company="Cosys SRL.">
...
namespace ServerWatchTower.Agent.ViewModel
{
    ...
    /// </summary>
    [Export("ServerWatchTower.Agent.ReportsViewModel"), PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class ReportsViewModel : ViewModelBase
    {
        #region Private fields

        /// <summary>
        /// The field which stores the data of the <see cref="ServerCards"/> property. Should not be accessed directly.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private System.Collections.ObjectModel.ObservableCollection<ServerCard> serverCardsField;
        ...
        /// <summary>
        /// Gets the collection of server cards to display.
        /// </summary>
        public System.Collections.ObjectModel.ObservableCollection<ServerCard> ServerCards
        {
            get => this.serverCardsField;

            private set
            {
                if (this.serverCardsField != value)
                {
                    this.serverCardsField = value;
                    this.NotifyChangeOf(nameof(this.ServerCards));
                }
            }
        }
        ...
        /// <summary>
        /// Initializes the command properties by creating the commands of the <see cref="ReportsViewModel"/>.
        /// </summary>
